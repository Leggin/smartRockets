...
function Rocket(dna) {
  ...
  //calculates the fitnes of this rocket
  ...
  //updates the position and velocity of this rocket
  ...
  //resets this rocket as if it were new in the pool
  ...
  //function to draw the rocket on the canvas as a rectangle
  this.show = function() {
    push();
    noStroke();
